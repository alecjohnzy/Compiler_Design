...
dictValues = dict()
constantFoldedList = []
print("Quadruple form after Constant Folding and Constant Propagation")
print("-------------------------------------")
...
for i in list_of_lines:
	i = i.strip("\n")
	op,arg1,arg2,res = i.split()
	if op=='=' and arg1[0]!='T' and not(arg1.isdigit()):
		copydict[res]=arg1
		#CopyPropList.append([op,arg1,arg2,res])
	if arg1 in copydict:
		if arg2 in copydict:
			CopyPropList.append([op,copydict[arg1],copydict[arg2],res])
		else:
			CopyPropList.append([op,copydict[arg1],arg2,res])
	elif arg2 in copydict:
		CopyPropList.append([op,arg1,copydict[arg2],res])
	else:
		CopyPropList.append([op,arg1,arg2,res])

for i in CopyPropList:
    if(i[0]=="="):
        print(i[3],i[0],i[1])
    elif(i[0] in ["+","-","*","/","==","<=","<",">",">="]):
        print(i[3],"=",i[1],i[0],i[2])
